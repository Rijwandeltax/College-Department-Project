...
<div class="pages">
		...
		<ul>
					 ...
					 <hr style="margin-top:1.5px; margin-bottom:1.5px; border-color:#CCCCCC">
					 <li style="margin-bottom:8px"><a href="placement-list.php"><span></span>PLACEMENT</a></li>
					 <hr style="margin-top:1.5px; margin-bottom:1.5px; border-color:#CCCCCC">
		...
		<div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Time-Table</h3></div>
  ...
  <tr>
	 ...
	 <th style="text-align:center">Download Time-Table</th>
	 </tr>
	 <?php
	 $i=0;
	 include("enter.php");
	 ...
	 <td style="text-align:center; color:#FF0000"><a href="images/<?=$r[0]?><?=$r[2]?><?=$r[4]?>.pdf">Download</a></td>
	 </tr>
	 <?php
	 }
	 ?>
