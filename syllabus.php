...
<div class="pages">
		...
		<div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Syllabus</h3></div>
  ...
  <tr>
	 ...
	 <th style="text-align:center">Download SYLLABUS</th>
	 </tr>
	 <?php
	 $i=0;
	 include("enter.php");
	 $rs=mysql_query("select * from syllebus" );
	 while($r=mysql_fetch_array($rs)){
	 ?>
	 <tr>
	 <td style="text-align:center"><?=$r[0]?></td>
	 <td style="text-align:center"><?=$r[1]?></td>
	 <td style="text-align:center; color:#FF0000"><a href="../../university dashbord/uploads/.pdf">Download</a></td>
	 </tr>
	 <?php
	 }
	 ?>
